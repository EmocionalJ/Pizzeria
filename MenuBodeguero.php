...
<body>
    <div class="container">
        ...
        <div class "table-container">
            <table class="tabla">
                <tr>
                    <td><a href="IngresarStock.php">Ingresar Stock</a></td>
                </tr>
                <tr>
                    <td><a href="CrearTransfactura.php">Crear transfactura</a></td>
                </tr>
                    <td><a href="CompararTransfactura.php">Comparar con transfactura</a></td>
                </tr>
            </table>
        </div>
