...
<body>
    <div class="container">
        ...
        <div class="table-container">
            <table class="tabla">
                <tr>
                    <td><a href="VerStock.php">Ver Stock proporcionado por bodeguero</a></td>
                </tr>
                <tr>
                    <td><a href="EditarComparaciones.php">Editar Comparaciones</a></td>
                </tr>
                <tr>
                    <td><a href="MovimientosStock.php">Movimiento Stock</a></td>
                </tr>
                <tr>
                    <td><a href="ModificarStock.php">Modificar Stock</a></td>
                </tr>
            </table>
        </div>
